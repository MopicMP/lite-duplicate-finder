# lite-duplicate-finder

> Lite find and remove duplicate files

[![PyPI version](https://badge.fury.io/py/lite-duplicate-finder.svg)](https://pypi.org/project/lite-duplicate-finder/)
...
```bash
pip install lite-duplicate-finder
```

## Quick Start

```python
from lite_duplicate_finder import finder
...
from lite_duplicate_finder import batch
